...
//			System.out.println("max="+max);
			...
			System.out.println("====================================================================================================");
			// 노래명 중에 가장 긴 제목의 노래와 가수명, 앨범명을 출력하시오.
			int maxlen=0;
//			for(int i=0;i<title.length;i++) {
//				if(title[i].length()>maxlen) {
//					maxlen=i;
//				}
//			}
			for(String t:title) {
			...
			for(i=0;i<title.length;i++) {
				if(maxlen==title[i].length()) {
					break;
				}
			}
			
			System.out.println("가장 긴 노래는 "+title[maxlen]+" "+singer[maxlen]);
			// 문자의 갯수 => length()
			System.out.println("====================================================================================================");
